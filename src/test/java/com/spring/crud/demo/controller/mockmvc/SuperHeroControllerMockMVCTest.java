...
public class SuperHeroControllerMockMVCTest implements BaseControllerTest<SuperHero, SuperHeroDTO> {
    ...
    public void testGivenNon_WhenGetAllRecords_ThenReturnListRecord() throws Exception {
        ...
        superHeroes.forEach(superHeroDTO -> new SuperHeroSupplier().accept(superHeroDTO));
    ...
    public void testGivenId_WhenGetRecordsById_ThenReturnRecord() throws Exception {
        ...
        SuperHeroDTO expectedSuperHero = new SuperHeroSupplier().apply(insertRecord);
    ...
    public void testGivenId_WhenDeleteRecord_ThenReturnTrue() throws Exception {
        ...
        SuperHeroDTO savedSuperHero = new SuperHeroSupplier().apply(superHero);
    ...
    class SuperHeroSupplier implements Consumer<SuperHeroDTO>, Function<SuperHeroDTO, SuperHeroDTO> {
        @Override
        ...
        @Override
        public SuperHeroDTO apply(SuperHeroDTO superHeroDTO) {
            try {
                String strSuperHero = mockMvc.perform(MockMvcRequestBuilders.post("/super-heroes")
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(superHeroDTO)))
                        .andDo(MockMvcResultHandlers.log())
                ...
                return objectMapper.readValue(strSuperHero, SuperHeroDTO.class);
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }
